...
angular.module('mentio', [])
    .directive('mentio', [
        ...
        '$document',
        '$timeout',
        function (mentioUtil, $compile, $log, $document, $timeout) {
            return {
                restrict: 'A',
                scope: {
                    macros: '=mentioMacros',
                ...
                controller: [
                    ...
                    '$attrs',
                    '$document',
                    function($scope, $timeout, $attrs, $document) {
                                    ...
                                    $scope.defaultSearch = function(locals) {
                                        ...
                                        angular.forEach($scope.items, function(item) {
                                            if ((item.name + item.email).toUpperCase().indexOf(locals.term.toUpperCase()) >= 0) {
                                                results.push(item);
                                            }
                                        });
                                    ...
                                    $scope.defaultSelect = function(locals) {
                                        return $scope.defaultTriggerChar + locals.item.name + ':' + locals.item.email;
                                    };
